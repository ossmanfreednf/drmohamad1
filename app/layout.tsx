...
export const metadata: Metadata = {
  metadataBase: new URL("https://drmohamadelharess.com"),
  ...
  openGraph: { title: "Dr. Mohamad El Haress, MD, FICS", description: "General Surgery, Complex Surgical Oncology & Advanced Laparoscopy in Beirut, Lebanon.", type: "website", locale: "en_LB", siteName: "Dr. Mohamad El Haress", url: "https://drmohamadelharess.com", images: [{ url: "/dr-mohamad-el-haress-portrait.png", width: 999, height: 1000, alt: "Dr. Mohamad El Haress, general surgeon and surgical oncologist" }] },
...
const physicianSchema = {
  "@context": "https://schema.org", "@type": "Physician", "@id": "https://drmohamadelharess.com/#physician", name: "Dr. Mohamad El Haress", givenName: "Mohamad", familyName: "El Haress", honorificPrefix: "Dr.", honorificSuffix: "MD, FICS",
  medicalSpecialty: ["General Surgery", "Surgical Oncology"], telephone: "+9613600777", image: "https://drmohamadelharess.com/dr-mohamad-el-haress-portrait.png",
  url: "https://drmohamadelharess.com", sameAs: ["https://orcid.org/0009-0007-5388-9762", "https://lb.linkedin.com/in/mohamad-el-haress-md-911040141", "https://www.cureus.com/users/1247243-mohamad-el-haress"], areaServed: [{ "@type": "Country", name: "Lebanon" }, { "@type": "City", name: "Beirut" }], address: { "@type": "PostalAddress", addressLocality: "Beirut", addressCountry: "LB" },
...
const websiteSchema = { "@context": "https://schema.org", "@type": "WebSite", "@id": "https://drmohamadelharess.com/#website", url: "https://drmohamadelharess.com", name: "Dr. Mohamad El Haress", inLanguage: "en", publisher: { "@id": "https://drmohamadelharess.com/#physician" } };
